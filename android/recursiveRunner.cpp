...
class RecursiveRunnerGameThreadJNIEnvCtx : public GameThreadJNIEnvCtx {
	public:
	StorageAPIAndroidImpl storageAPI;
	
    void init(JNIEnv* pEnv, jobject assetMgr) {
	    GameThreadJNIEnvCtx::init(pEnv, assetMgr);
	    storageAPI.init(pEnv);
    }
...
GameHolder* GameHolder::build() {
	...
	RecursiveRunnerGameThreadJNIEnvCtx* jniCtx = new RecursiveRunnerGameThreadJNIEnvCtx();
